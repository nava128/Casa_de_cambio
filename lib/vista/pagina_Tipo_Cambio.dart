...
import 'package:nava/componentes/mi_cls_boton.dart';
import 'package:nava/vista/pagina_inicio.dart';
import 'package:nava/servicios/sunat_service.dart';
...
class _TipoCambioScreenState extends State<TipoCambioScreen> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    final DateTime picked = await showDatePicker(context: context, initialDate: selectedDate, firstDate: DateTime(2020, 8, 15), lastDate: DateTime(hoy.year, hoy.month, hoy.day));
